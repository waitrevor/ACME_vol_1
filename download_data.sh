...
LABS=("Conditioning_Stability" "DataVisualization" "Differentiation" "DrazinInverse" "FacialRecognition" "ImageSegmentation" "KMeans" "LeastSquares_Eigenvalues" "LinearTransformations" "MatplotlibIntro" "NumpyIntro" "PageRank" "Profiling" "SQL1" "SQL2" "SVD_ImageCompression" "UnixShell1")
